    ...
    <div class="body">
        <div class="row">
            <div class="col-6">
                ...
                <div>
                    <button type="submit" class="buttonCheckout"><script>alert('Silakan ke kasir untuk melakukan pembayaran!!!'); window.location.href='statuspesanan.php';</script>Lihat Status Pesanan</button>
                </div>
            </div>
        </div>
    </div>
