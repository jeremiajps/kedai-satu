    ...
    <div class="body">
        <div class="row">
            <div class="col-6">
                ...
                <div>
                    <button type="submit" onclick="window.location.href='statuspesanan.php'" class="buttonProses"><script>alert('Silakan ke kasir untuk melakukan pembayaran!!!')</script>Status Pesanan</button>
                </div>
            </div>
        </div>
    </div>
