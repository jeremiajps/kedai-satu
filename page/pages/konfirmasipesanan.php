    ...
    <div class="body">
        <div class="row">
            <div class="col-6">
                ...
                <div>
                    <button type="submit" onclick="window.location.href='/index.php'" class="buttonCheckout"><script>alert('Silakan ke kasir untuk melakukan pembayaran!!!')</script>Lihat Status Pesanan</button>
                </div>
            </div>
        </div>
    </div>
